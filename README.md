...
2. [Stacked Bar Chart](#stacked-bar-chart)
    ...
    + [Examples](#stacked-bar-chart-examples)
        - [Basic Bar chart](#stacked-bar-chart-examples-basic)
        - [Full Option Bar chart](#stacked-bar-chart-examples-full-option)
...
```javascript
var barChart = new StackedBarChart(container_element, data, stack, options)
```
